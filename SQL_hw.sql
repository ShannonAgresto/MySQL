...
# 2c. Find all actors whose last names contain the letters LI. This time, order the rows by last name and first name, in that order:
 ...
 SELECT * FROM country WHERE country IN ('Afganistan', 'Bangladesh', 'China');
...
DELETE FROM actor WHERE first_name = "GROUCHO" AND last_name = "WILLIAMS";
UPDATE actor
...
CREATE 'address_temp' TABLE [IF NOT EXISTS] 'address' (
NOT NULL,
PRIMARY KEY (id),
VARCHAR (60)
); 
...
FROM staff 
JOIN ON address.address_id=staff.last name
